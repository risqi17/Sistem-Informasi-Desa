            ...
            <div class="col-lg-12">
                <div class="card m-b-30">
                    <div class="card-body">
                        ...
                        <form action="{{ url('admin/information/announcement/update') }}" method="POST">
                            @csrf 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" value="{{ $data->title }}" type="text" name="judul" placeholder="Contoh : Gerak Jalan Desa, Karnaval Kemerdekaan, DLLs" id="nama">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="nama" class="col-sm-2 col-form-label">Deskripsi</label>
                                <div class="col-sm-10"> 
                                    <textarea class="form-control" name="deskripsi">{{ $data->desc }}</textarea>
                                </div>
                            </div> 
                            <div class="form-group row">
