            ...
            <div class="col-lg-12">
                <div class="card m-b-30">
                    <div class="card-body">
                        ...
                        <form action="{{ url('admin/information/agenda/save') }}" method="POST">
                            @csrf
                            <div class="form-group row">
                                <label for="nama" class="col-sm-2 col-form-label">Nama Agenda</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="nama_agenda" placeholder="Contoh : Rapat Panitia Hari Kemerdekaan" id="nama">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="nama" class="col-sm-2 col-form-label">Tanggal</label>
                                <div class="col-sm-4">
                                    <input class="form-control" type="text" name="tanggal" placeholder="2019-07-01" id="mdate">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="nama" class="col-sm-2 col-form-label">Jam</label>
                                <div class="col-sm-1">
                                    <input class="form-control" type="text" name="jam1" placeholder="07:00" id="timepicker">
                                </div>
                                <label for="nama" class="col-sm-1 col-form-label">Sampai</label>
                                <div class="col-sm-2">
                                    <input class="form-control" type="text" name="jam2" placeholder="Contoh : Selesai" id="nama">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="nama" class="col-sm-2 col-form-label">Tempat</label>
                                <div class="col-sm-10">
                                    <textarea class="form-control" rows="5" name="tempat" placeholder="Contoh : Kantor Desa, Aula, DLL"></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
