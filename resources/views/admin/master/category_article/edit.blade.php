...
<div class="page-content-wrapper ">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form action="{{ url('admin/master/category_article/update') }}" method="POST">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="nama"  value="{{ $c->name_cat }}" placeholder="Contoh : Edukasi, Pendidikan, Olahraga, dll." id="nama" autofocus>
                                </div>
                            </div>
                            @endforeach
                            <div class="form-group row">
